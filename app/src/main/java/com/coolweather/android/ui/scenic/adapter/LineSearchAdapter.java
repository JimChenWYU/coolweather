...
public class LineSearchAdapter extends BaseQuickAdapter<ScenicLineBean, BaseViewHolder>{

    public LineSearchAdapter(int layoutResId, List<ScenicLineBean> data) {
